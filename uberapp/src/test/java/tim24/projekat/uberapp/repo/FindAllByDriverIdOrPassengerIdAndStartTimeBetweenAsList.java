...
public class FindAllByDriverIdOrPassengerIdAndStartTimeBetweenAsList {
    ...
    public void shouldFindRidesForPassengerIfRidesAreInIntervalAndBelongToPassenger() {
        ...
        List<Ride> rides = rideRepository.findAllByDriverIdOrPassengerIdAndStartTimeBetweenAsList(passenger.getId(),now,end);
    ...
    public void shouldNotFindRideIfRideStartsBeforeStartDatePassenger() {
        ...
        List<Ride> rides = rideRepository.findAllByDriverIdOrPassengerIdAndStartTimeBetweenAsList(passenger.getId(),interval_start,interval_end);
    ...
    public void shouldFindRidesForPassengerIfThereAreMultiplePassengersInRide() {
        ...
        List<Ride> rides = rideRepository.findAllByDriverIdOrPassengerIdAndStartTimeBetweenAsList(passenger1.getId(),interval_start,interval_end);
        assertFalse(rides.isEmpty());
        assertEquals(rides.size(),3);

        rides = rideRepository.findAllByDriverIdOrPassengerIdAndStartTimeBetweenAsList(passenger2.getId(),interval_start,interval_end);
        assertFalse(rides.isEmpty());
    ...
    public void shouldFindRidesForDriverIfRidesAreInIntervalAndBelongToDriver() {
        ...
        List<Ride> rides = rideRepository.findAllByDriverIdOrPassengerIdAndStartTimeBetweenAsList(driver.getId(),now,end);
        assertFalse(rides.isEmpty());
        assertEquals(rides.size(),1);
    ...
    public void shouldNotFindRideIfRideStartsBeforeStartDateDriver() {
        ...
        List<Ride> rides = rideRepository.findAllByDriverIdOrPassengerIdAndStartTimeBetweenAsList(driver.getId(),interval_start,interval_end);
        assertTrue(rides.isEmpty());
