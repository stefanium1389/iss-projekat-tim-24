package tim24.projekat.uberapp.config;
...
public class WebSocketConfig implements WebSocketMessageBrokerConfigurer
{
    ...
    public void configureMessageBroker(MessageBrokerRegistry registry) {
        registry.setApplicationDestinationPrefixes("/socket") // Prefiks koji koji se koristi za mapiranje svih poruka.
                // Klijenti moraju da ga navedu kada salju poruku serveru.
                // Svaki URL bi pocinjao ovako: http://localhost:8080/socket/…/…
                .enableSimpleBroker("/notification", "/map"); // Definisanje topic-a (ruta) na koje klijenti mogu da se pretplate.
